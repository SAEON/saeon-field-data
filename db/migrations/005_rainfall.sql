-- =============================================================
-- 005_rainfall.sql
-- Pre-computed 5-minute rainfall aggregates derived from QA-passed tips.
--
...
--
-- raw_measurements.flag_reason gives granular cause within each qa_flag type.
--
...
CREATE TABLE rainfall (
  ...
  double_tip_count   INTEGER      NOT NULL DEFAULT 0,
  interfere_count    INTEGER      NOT NULL DEFAULT 0,
  pseudo_event_count INTEGER      NOT NULL DEFAULT 0,
  -- pseudo_event breakdown: manual_tip_count + non_rainfall_count = pseudo_event_count
  manual_tip_count   INTEGER      NOT NULL DEFAULT 0,
  non_rainfall_count INTEGER      NOT NULL DEFAULT 0,
  processed_at       TIMESTAMPTZ  NOT NULL DEFAULT NOW(),
  UNIQUE (stream_id, period_start)
);

-- Time-series query indices
